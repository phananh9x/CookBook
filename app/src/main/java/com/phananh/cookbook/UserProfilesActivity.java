...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void updateUserProfiles() {
        ...
        mAPIService.getUserProfiles(token, id, userProfiles).enqueue(new Callback<UserProfileResponse>() {
            @Override
    ...
    public void loadProfiles(){
        mAPIService = ApiUtils.getAPIService();
        mAPIService.getUserProfiles(token,id).enqueue(new Callback<UserProfilesResults>() {
            @Override
